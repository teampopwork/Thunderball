...
// GLOBAL: POPCAPGAME1 0x00650578
static bool gNeedRecalcVariableToIdMap = false;

// FUNCTION: POPCAPGAME1 0x0041f9f0
bool Sexy::ExtractResourcesByName(ResourceManager* theManager, const char* theName)
{
	// STRING: POPCAPGAME1 0x005d7340
	if (strcmp(theName, "Adventure") == 0) {
		return ExtractAdventureResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d7334
	if (strcmp(theName, "Character") == 0) {
		return ExtractCharacterResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d732c
	if (strcmp(theName, "Dialog") == 0) {
		return ExtractDialogResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d7324
	if (strcmp(theName, "Game") == 0) {
		return ExtractGameResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d731c
	if (strcmp(theName, "Help") == 0) {
		return ExtractHelpResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d7318
	if (strcmp(theName, "IP") == 0) {
		return ExtractIPResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d7310
	if (strcmp(theName, "Init") == 0) {
		return ExtractInitResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d7304
	if (strcmp(theName, "Interface") == 0) {
		return ExtractInterfaceResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d72f8
	if (strcmp(theName, "LevelSelect") == 0) {
		return ExtractLevelSelectResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d72f0
	if (strcmp(theName, "Load") == 0) {
		return ExtractLoadResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d72e0
	if (strcmp(theName, "LoadingThread") == 0) {
		return ExtractLoadingThreadResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d257c
	if (strcmp(theName, "LuckySpin") == 0) {
		return ExtractLuckySpinResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d72d4
	if (strcmp(theName, "MainMenu") == 0) {
		return ExtractMainMenuResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d72cc
	if (strcmp(theName, "Story") == 0) {
		return ExtractStoryResources(theManager);
	}
	// STRING: POPCAPGAME1 0x005d72c4
	if (strcmp(theName, "Upsell") == 0) {
		return ExtractUpsellResources(theManager);
	}
	return false;
}

// FUNCTION: POPCAPGAME1
...
// FUNCTION: POPCAPGAME1 0x004129f0
bool Sexy::ExtractAdventureResources(ResourceManager* theManager)
{
	...
	try {
		// STRING: POPCAPGAME1 0x005d2d94
		IMAGE_ADV_ADVENTURE = aMgr.GetImageThrow("IMAGE_ADV_ADVENTURE");
		// STRING: POPCAPGAME1 0x005d2d7c
...
// FUNCTION: POPCAPGAME1 0x00412b20
...
// FUNCTION: POPCAPGAME1 0x004130b0
...
// FUNCTION: POPCAPGAME1 0x00414210
...
// FUNCTION: POPCAPGAME1 0x004161e0
...
// FUNCTION: POPCAPGAME1 0x004163d0
...
// FUNCTION: POPCAPGAME1 0x00416cb0
...
// FUNCTION: POPCAPGAME1 0x00417290
...
// FUNCTION: POPCAPGAME1 0x00417ea0
...
// FUNCTION: POPCAPGAME1 0x004183d0
...
// FUNCTION: POPCAPGAME1 0x00418900
...
// FUNCTION: POPCAPGAME1 0x0041a000
...
// FUNCTION: POPCAPGAME1 0x0041a420
...
// FUNCTION: POPCAPGAME1 0x0041abf0
...
// FUNCTION: POPCAPGAME1 0x0041adf0
...
// FUNCTION: POPCAPGAME1 0x0041b9f0
...
// FUNCTION: POPCAPGAME1 0x0041bab0
...
// These functions seem to be combined into one
...
// FUNCTION: POPCAPGAME1 0x00403930
const char* Sexy::GetStringIdById(int theId)
{
	switch (theId) {
	case IMAGE_SCREENFRAMELEFT_ID:
		return "IMAGE_SCREENFRAMELEFT";
	case IMAGE_SCREENFRAMERIGHT_ID:
		return "IMAGE_SCREENFRAMERIGHT";
	case IMAGE_SCREENFRAMETOP_ID:
		return "IMAGE_SCREENFRAMETOP";
	case IMAGE_SCREENFRAMEBOTTOM_ID:
		return "IMAGE_SCREENFRAMEBOTTOM";
	case IMAGE_SUNGLOW_ID:
		return "IMAGE_SUNGLOW";
	case IMAGE_CURSOR_POINTER_ID:
		return "IMAGE_CURSOR_POINTER";
	case IMAGE_CURSOR_HAND_ID:
		return "IMAGE_CURSOR_HAND";
	case IMAGE_CURSOR_DRAGGING_ID:
		return "IMAGE_CURSOR_DRAGGING";
	case IMAGE_CURSOR_TEXT_ID:
		return "IMAGE_CURSOR_TEXT";
	case IMAGE_WIN_MINIMIZE_ID:
		return "IMAGE_WIN_MINIMIZE";
	case IMAGE_WIN_UNMAX_ID:
		return "IMAGE_WIN_UNMAX";
	case IMAGE_WIN_CLOSE_ID:
		return "IMAGE_WIN_CLOSE";
	case SOUND_MORNING_ID:
		return "SOUND_MORNING";
	case FONT_OVERLOAD16_ID:
		return "FONT_OVERLOAD16";
	case FONT_OVERLOAD16OUTLINE_ID:
		return "FONT_OVERLOAD16OUTLINE";
	case FONT_OVERLOAD16OUTLINE2_ID:
		return "FONT_OVERLOAD16OUTLINE2";
	case IMAGE_LOAD_BACK_ID:
		return "IMAGE_LOAD_BACK";
	case IMAGE_LOAD_HILL_ID:
		return "IMAGE_LOAD_HILL";
	case IMAGE_LOAD_OVERLAY_ID:
		return "IMAGE_LOAD_OVERLAY";
	case IMAGE_LOAD_LIGHTS_ID:
		return "IMAGE_LOAD_LIGHTS";
	case IMAGE_LOAD_LOGO_ID:
		return "IMAGE_LOAD_LOGO";
	case IMAGE_LOAD_SHADOW_ID:
		return "IMAGE_LOAD_SHADOW";
	case IMAGE_LOAD_SUNHEAD_ID:
		return "IMAGE_LOAD_SUNHEAD";
	case IMAGE_LOAD_PLAYNOW_ID:
		return "IMAGE_LOAD_PLAYNOW";
	case IMAGE_LOAD_BALL_ID:
		return "IMAGE_LOAD_BALL";
	case IMAGE_LOAD_DELUXE_ID:
		return "IMAGE_LOAD_DELUXE";
	case IMAGE_LOAD_TM_ID:
		return "IMAGE_LOAD_TM";
	case IMAGE_LOAD_POPCAP_ID:
		return "IMAGE_LOAD_POPCAP";
	case IMAGE_PARTNER_ID:
		return "IMAGE_PARTNER";
	case FONT_PLAIN_ID:
		return "FONT_PLAIN";
	case FONT_PLAIN2BIG_ID:
		return "FONT_PLAIN2BIG";
	case FONT_SMALL_ID:
		return "FONT_SMALL";
	case FONT_SMALLMONO_ID:
		return "FONT_SMALLMONO";
	case FONT_SCORE_DISP_ID:
		return "FONT_SCORE_DISP";
	case FONT_SMALL_DISP_ID:
		return "FONT_SMALL_DISP";
	case FONT_BALLSLEFT_ID:
		return "FONT_BALLSLEFT";
	case FONT_BUTTON_ID:
		return "FONT_BUTTON";
	case FONT_STAGE_ID:
		return "FONT_STAGE";
	case FONT_BONK_ID:
		return "FONT_BONK";
	case FONT_OVERLOAD10_ID:
		return "FONT_OVERLOAD10";
	case FONT_OVERLOAD12_ID:
		return "FONT_OVERLOAD12";
	case FONT_OVERLOAD24_ID:
		return "FONT_OVERLOAD24";
	case FONT_OVERLOADMONO10_ID:
		return "FONT_OVERLOADMONO10";
	case FONT_OVERLOADMONO12_ID:
		return "FONT_OVERLOADMONO12";
	case FONT_OVERLOAD10OUTLINE_ID:
		return "FONT_OVERLOAD10OUTLINE";
	case FONT_OVERLOAD12OUTLINE_ID:
		return "FONT_OVERLOAD12OUTLINE";
	case FONT_OVERLOAD24OUTLINE_ID:
		return "FONT_OVERLOAD24OUTLINE";
	case FONT_OVERLOAD24GRAD1_ID:
		return "FONT_OVERLOAD24GRAD1";
	case FONT_OVERLOAD24GRAD2_ID:
		return "FONT_OVERLOAD24GRAD2";
	case FONT_PLAINOUTLINE_ID:
		return "FONT_PLAINOUTLINE";
	case FONT_PLAIN2_ID:
		return "FONT_PLAIN2";
	case FONT_PLAIN2OUTLINE_ID:
		return "FONT_PLAIN2OUTLINE";
	case FONT_PLAIN2BIGOUTLINE_ID:
		return "FONT_PLAIN2BIGOUTLINE";
	case SOUND_PEGHIT_LOW_ID:
		return "SOUND_PEGHIT_LOW";
	case SOUND_PEGHIT_ID:
		return "SOUND_PEGHIT";
	case SOUND_PEGHIT2_ID:
		return "SOUND_PEGHIT2";
	case SOUND_PEGHIT3_ID:
		return "SOUND_PEGHIT3";
	case SOUND_EXTRABALL_ID:
		return "SOUND_EXTRABALL";
	case SOUND_EXTRABALL2_ID:
		return "SOUND_EXTRABALL2";
	case SOUND_EXTRABALL3_ID:
		return "SOUND_EXTRABALL3";
	case SOUND_MISS_ID:
		return "SOUND_MISS";
	case SOUND_COINSPIN_ID:
		return "SOUND_COINSPIN";
	case SOUND_COINSPIN_NO_ID:
		return "SOUND_COINSPIN_NO";
	case SOUND_FREEBALL_ID:
		return "SOUND_FREEBALL";
	case SOUND_PENALTY_ID:
		return "SOUND_PENALTY";
	case SOUND_LEVELWON_ID:
		return "SOUND_LEVELWON";
	case SOUND_LEVELDONE_ID:
		return "SOUND_LEVELDONE";
	case SOUND_LEVELLOST_ID:
		return "SOUND_LEVELLOST";
	case SOUND_POWERUP_ID:
		return "SOUND_POWERUP";
	case SOUND_AAH_ID:
		return "SOUND_AAH";
	case SOUND_MULTIBALL_ID:
		return "SOUND_MULTIBALL";
	case SOUND_PEGPOP_ID:
		return "SOUND_PEGPOP";
	case SOUND_EXPLODE_ID:
		return "SOUND_EXPLODE";
	case SOUND_BUTTON1_ID:
		return "SOUND_BUTTON1";
	case SOUND_BUTTON2_ID:
		return "SOUND_BUTTON2";
	case SOUND_MOUSEOVER_ID:
		return "SOUND_MOUSEOVER";
	case SOUND_DING_ID:
		return "SOUND_DING";
	case SOUND_POINTBOOST_ID:
		return "SOUND_POINTBOOST";
	case SOUND_TING_ID:
		return "SOUND_TING";
	case SOUND_AWARD_ID:
		return "SOUND_AWARD";
	case SOUND_APPLAUSE_ID:
		return "SOUND_APPLAUSE";
	case SOUND_SKILLSHOT_ID:
		return "SOUND_SKILLSHOT";
	case SOUND_SPOOKYBALL2_ID:
		return "SOUND_SPOOKYBALL2";
	case SOUND_SPOOKYBALL3_ID:
		return "SOUND_SPOOKYBALL3";
	case SOUND_SPOOKYBALL4_ID:
		return "SOUND_SPOOKYBALL4";
	case SOUND_BUBBLES_ID:
		return "SOUND_BUBBLES";
	case SOUND_FLIP_ID:
		return "SOUND_FLIP";
	case SOUND_BUCKETHIT_ID:
		return "SOUND_BUCKETHIT";
	case SOUND_CANNONCOCK_ID:
		return "SOUND_CANNONCOCK";
	case SOUND_CANNONSHOT_ID:
		return "SOUND_CANNONSHOT";
	case SOUND_SCORECOUNTER_ID:
		return "SOUND_SCORECOUNTER";
	case SOUND_FLIPPERUP_ID:
		return "SOUND_FLIPPERUP";
	case SOUND_FLIPPERDOWN_ID:
		return "SOUND_FLIPPERDOWN";
	case SOUND_FLIPPERBOUNCE_ID:
		return "SOUND_FLIPPERBOUNCE";
	case SOUND_RAINBOW_ID:
		return "SOUND_RAINBOW";
	case SOUND_FIREWORKS1_ID:
		return "SOUND_FIREWORKS1";
	case SOUND_FIREWORKS2_ID:
		return "SOUND_FIREWORKS2";
	case SOUND_RICHOCHET_ID:
		return "SOUND_RICHOCHET";
	case SOUND_CYMBAL_ID:
		return "SOUND_CYMBAL";
	case SOUND_SIGH_ID:
		return "SOUND_SIGH";
	case SOUND_WOOSH_ID:
		return "SOUND_WOOSH";
	case SOUND_TEXT_WOOSH_ID:
		return "SOUND_TEXT_WOOSH";
	case SOUND_WHISTLE_ID:
		return "SOUND_WHISTLE";
	case SOUND_FEVERHIT_ID:
		return "SOUND_FEVERHIT";
	case SOUND_FIREBALLLOOP_ID:
		return "SOUND_FIREBALLLOOP";
	case SOUND_FIREBALLSHOT_ID:
		return "SOUND_FIREBALLSHOT";
	case SOUND_FIREBALLBOUNCE_ID:
		return "SOUND_FIREBALLBOUNCE";
	case SOUND_POWERUP_GUIDE_ID:
		return "SOUND_POWERUP_GUIDE";
	case SOUND_POWERUP_MULTIBALL_ID:
		return "SOUND_POWERUP_MULTIBALL";
	case SOUND_POWERUP_PYRAMID_ID:
		return "SOUND_POWERUP_PYRAMID";
	case SOUND_POWERUP_SPACEBLAST_ID:
		return "SOUND_POWERUP_SPACEBLAST";
	case SOUND_POWERUP_FLIPPERS_ID:
		return "SOUND_POWERUP_FLIPPERS";
	case SOUND_POWERUP_SPOOKYBALL_ID:
		return "SOUND_POWERUP_SPOOKYBALL";
	case SOUND_POWERUP_FLOWERPOWER_ID:
		return "SOUND_POWERUP_FLOWERPOWER";
	case SOUND_POWERUP_LUCKYSPIN_ID:
		return "SOUND_POWERUP_LUCKYSPIN";
	case SOUND_POWERUP_FIREBALL_ID:
		return "SOUND_POWERUP_FIREBALL";
	case SOUND_POWERUP_ZEN_ID:
		return "SOUND_POWERUP_ZEN";
	case SOUND_GONG_ID:
		return "SOUND_GONG";
	case SOUND_SLOWMO_ID:
		return "SOUND_SLOWMO";
	case SOUND_TYPING_ID:
		return "SOUND_TYPING";
	case SOUND_TONELO_ID:
		return "SOUND_TONELO";
	case SOUND_TONE_ID:
		return "SOUND_TONE";
	case SOUND_TONEHI_ID:
		return "SOUND_TONEHI";
	case SOUND_TONESUPERHI_ID:
		return "SOUND_TONESUPERHI";
	case SOUND_STAMP_ID:
		return "SOUND_STAMP";
	case SOUND_ADD_BALL_ID:
		return "SOUND_ADD_BALL";
	case SOUND_DIALOG_MOVE_ID:
		return "SOUND_DIALOG_MOVE";
	case SOUND_FIREWORKPOP_ID:
		return "SOUND_FIREWORKPOP";
	case IMAGE_INT_BALL_ID:
		return "IMAGE_INT_BALL";
	case IMAGE_INT_BALLBACK_ID:
		return "IMAGE_INT_BALLBACK";
	case IMAGE_INT_BUTTONCOVER_ID:
		return "IMAGE_INT_BUTTONCOVER";
	case IMAGE_INT_CANNON_ID:
		return "IMAGE_INT_CANNON";
	case IMAGE_INT_CANNONCOVER_ID:
		return "IMAGE_INT_CANNONCOVER";
	case IMAGE_INT_PLUNGER_ID:
		return "IMAGE_INT_PLUNGER";
	case IMAGE_INT_BALLGLASS_ID:
		return "IMAGE_INT_BALLGLASS";
	case IMAGE_INT_FEVERMETER_ID:
		return "IMAGE_INT_FEVERMETER";
	case IMAGE_INT_FEVERMETERTOP_ID:
		return "IMAGE_INT_FEVERMETERTOP";
	case IMAGE_INT_FEVERMETERBOTTOM_ID:
		return "IMAGE_INT_FEVERMETERBOTTOM";
	case IMAGE_INT_FEVERRAILING_ID:
		return "IMAGE_INT_FEVERRAILING";
	case IMAGE_INT_FEVERBARS_ID:
		return "IMAGE_INT_FEVERBARS";
	case IMAGE_INT_FEVERBARLITES_ID:
		return "IMAGE_INT_FEVERBARLITES";
	case IMAGE_INT_COUNTER_ID:
		return "IMAGE_INT_COUNTER";
	case IMAGE_INT_FREEBALLMETER_ID:
		return "IMAGE_INT_FREEBALLMETER";
	case IMAGE_INT_FREEBALLMETERTOP_ID:
		return "IMAGE_INT_FREEBALLMETERTOP";
	case IMAGE_INT_BACKSHADOW_ID:
		return "IMAGE_INT_BACKSHADOW";
	case IMAGE_INT_FEVERGLOW_ID:
		return "IMAGE_INT_FEVERGLOW";
	case IMAGE_INT_FEVERGLOW1_ID:
		return "IMAGE_INT_FEVERGLOW1";
	case IMAGE_INT_FEVERGLOW2_ID:
		return "IMAGE_INT_FEVERGLOW2";
	case IMAGE_INT_FEVERGLOW3_ID:
		return "IMAGE_INT_FEVERGLOW3";
	case IMAGE_INT_SCOREHILIGHT_ID:
		return "IMAGE_INT_SCOREHILIGHT";
	case IMAGE_INT_BALLOMASKBL_ID:
		return "IMAGE_INT_BALLOMASKBL";
	case IMAGE_INT_BALLOMASKBR_ID:
		return "IMAGE_INT_BALLOMASKBR";
	case IMAGE_INT_BALLOMASKTL_ID:
		return "IMAGE_INT_BALLOMASKTL";
	case IMAGE_INT_BALLOMASKTR_ID:
		return "IMAGE_INT_BALLOMASKTR";
	case IMAGE_INT_FBCENTERDISC_ID:
		return "IMAGE_INT_FBCENTERDISC";
	case IMAGE_INT_FBGLOW_ID:
		return "IMAGE_INT_FBGLOW";
	case IMAGE_INT_FBFREEBALL_ID:
		return "IMAGE_INT_FBFREEBALL";
	case IMAGE_INT_FBLIGHTUP_ID:
		return "IMAGE_INT_FBLIGHTUP";
	case IMAGE_INT_FBPOINTS_ID:
		return "IMAGE_INT_FBPOINTS";
	case IMAGE_IP_B_ID:
		return "IMAGE_IP_B";
	case IMAGE_IP_BLC_ID:
		return "IMAGE_IP_BLC";
	case IMAGE_IP_BRC_ID:
		return "IMAGE_IP_BRC";
	case IMAGE_IP_L1_ID:
		return "IMAGE_IP_L1";
	case IMAGE_IP_L2_ID:
	...
	case IMAGE_IP_R2_ID:
		return "IMAGE_IP_R2";
	case IMAGE_IP_TL1_ID:
		return "IMAGE_IP_TL1";
	case IMAGE_IP_TL2_ID:
		return "IMAGE_IP_TL2";
	case IMAGE_IP_TR1_ID:
		return "IMAGE_IP_TR1";
	case IMAGE_IP_TR2_ID:
		return "IMAGE_IP_TR2";
	case IMAGE_IP_TLC_ID:
		return "IMAGE_IP_TLC";
	case IMAGE_IP_TRC_ID:
		return "IMAGE_IP_TRC";
	case IMAGE_IP_SEAMS_ID:
		return "IMAGE_IP_SEAMS";
	case IMAGE_IP_SHOOTERBACK_ID:
		return "IMAGE_IP_SHOOTERBACK";
	case IMAGE_IP_SHOOTER_ID:
		return "IMAGE_IP_SHOOTER";
	case IMAGE_IP_BALLOTRON_ID:
		return "IMAGE_IP_BALLOTRON";
	case IMAGE_IP_FEVERMETER_ID:
		return "IMAGE_IP_FEVERMETER";
	case IMAGE_IP_LWINDOW_ID:
		return "IMAGE_IP_LWINDOW";
	case IMAGE_IP_RWINDOW_ID:
		return "IMAGE_IP_RWINDOW";
	case IMAGE_IP_SHOOTERORB_ID:
		return "IMAGE_IP_SHOOTERORB";
	case IMAGE_IP_POWERUPBANNER_ID:
		return "IMAGE_IP_POWERUPBANNER";
	case IMAGE_IP_ORBGLOW_ID:
		return "IMAGE_IP_ORBGLOW";
	case IMAGE_MM_RIGHT_ID:
		return "IMAGE_MM_RIGHT";
	case IMAGE_MM_TOP_ID:
		return "IMAGE_MM_TOP";
	case IMAGE_MM_LEFT_ID:
		return "IMAGE_MM_LEFT";
	case IMAGE_MM_BOTTOM_ID:
		return "IMAGE_MM_BOTTOM";
	case IMAGE_MM_FOREGROUND_ID:
		return "IMAGE_MM_FOREGROUND";
	case IMAGE_MM_BACKGROUND_ID:
		return "IMAGE_MM_BACKGROUND";
	case IMAGE_MM_BJORN_ID:
		return "IMAGE_MM_BJORN";
	case IMAGE_MM_BLANKSUN_ID:
		return "IMAGE_MM_BLANKSUN";
	case IMAGE_MM_SPEECHBUBBLE_ID:
		return "IMAGE_MM_SPEECHBUBBLE";
	case IMAGE_MM_CRY_ID:
		return "IMAGE_MM_CRY";
	case IMAGE_MM_BUYIT_ID:
		return "IMAGE_MM_BUYIT";
	case IMAGE_MM_CERTIFICATE_ID:
		return "IMAGE_MM_CERTIFICATE";
	case IMAGE_MM_CERTIFICATEOK_ID:
		return "IMAGE_MM_CERTIFICATEOK";
	case IMAGE_MM_APPROVEDSTAMP_ID:
		return "IMAGE_MM_APPROVEDSTAMP";
	case IMAGE_MM_TROPHIES_ID:
		return "IMAGE_MM_TROPHIES";
	case IMAGE_MM_TROPHYREVEAL_ID:
		return "IMAGE_MM_TROPHYREVEAL";
	case IMAGE_MM_ADVENTURE_ID:
		return "IMAGE_MM_ADVENTURE";
	case IMAGE_MM_SOLO_ID:
		return "IMAGE_MM_SOLO";
	case IMAGE_MM_DUEL_ID:
		return "IMAGE_MM_DUEL";
	case IMAGE_MM_CHALLENGE_ID:
		return "IMAGE_MM_CHALLENGE";
	case IMAGE_LS_LEVELSCREEN_ID:
		return "IMAGE_LS_LEVELSCREEN";
	case IMAGE_LS_LEVELSCREENLEFT_ID:
		return "IMAGE_LS_LEVELSCREENLEFT";
	case IMAGE_LS_LEVELSCREENRIGHT_ID:
		return "IMAGE_LS_LEVELSCREENRIGHT";
	case IMAGE_LS_LEVELSELECTOR_ID:
		return "IMAGE_LS_LEVELSELECTOR";
	case IMAGE_LS_BACKBUTTON_ID:
		return "IMAGE_LS_BACKBUTTON";
	case IMAGE_LS_NEXTBUTTON_ID:
		return "IMAGE_LS_NEXTBUTTON";
	case IMAGE_LS_MAINMENUBUTTON_ID:
		return "IMAGE_LS_MAINMENUBUTTON";
	case IMAGE_LS_RANDOMBUTTON_ID:
		return "IMAGE_LS_RANDOMBUTTON";
	case IMAGE_LS_LOCK_ID:
		return "IMAGE_LS_LOCK";
	case IMAGE_LS_LOCK_SMALL_ID:
		return "IMAGE_LS_LOCK_SMALL";
	case IMAGE_LS_CHALLENGEBADGE_ID:
		return "IMAGE_LS_CHALLENGEBADGE";
	case IMAGE_LS_RANDOMLEVEL_ID:
		return "IMAGE_LS_RANDOMLEVEL";
	case IMAGE_LS_TINYBLUERIBBON_ID:
		return "IMAGE_LS_TINYBLUERIBBON";
	case IMAGE_HELP_SCREEN_ID:
		return "IMAGE_HELP_SCREEN";
	case IMAGE_HELP_MODES_ID:
		return "IMAGE_HELP_MODES";
	case IMAGE_HELP_BUTTONOVERLAY_ID:
		return "IMAGE_HELP_BUTTONOVERLAY";
	case IMAGE_HELP_ICONS_ID:
		return "IMAGE_HELP_ICONS";
	case IMAGE_HAT_ID:
		return "IMAGE_HAT";
	case IMAGE_MAGICHAT_ID:
		return "IMAGE_MAGICHAT";
	case IMAGE_SPARKLE_ID:
		return "IMAGE_SPARKLE";
	case IMAGE_SPARKLE_FEVER_ID:
		return "IMAGE_SPARKLE_FEVER";
	case IMAGE_STREAK_ID:
		return "IMAGE_STREAK";
	case IMAGE_FLOWER_ID:
		return "IMAGE_FLOWER";
	case IMAGE_POWERUPICON_ID:
		return "IMAGE_POWERUPICON";
	case IMAGE_SCOREICON_ID:
		return "IMAGE_SCOREICON";
	case IMAGE_BONUSHALO_ID:
		return "IMAGE_BONUSHALO";
	case IMAGE_BONUSGLOW_ID:
		return "IMAGE_BONUSGLOW";
	case IMAGE_BONUSGLOW_GREEN_ID:
		return "IMAGE_BONUSGLOW_GREEN";
	case IMAGE_BONUSGLOW_BLUE_ID:
		return "IMAGE_BONUSGLOW_BLUE";
	case IMAGE_BONUS5000_ID:
		return "IMAGE_BONUS5000";
	case IMAGE_BONUS10000_ID:
		return "IMAGE_BONUS10000";
	case IMAGE_BONUS25000_ID:
		return "IMAGE_BONUS25000";
	case IMAGE_BONUS50000_ID:
		return "IMAGE_BONUS50000";
	case IMAGE_BONUS100000_ID:
		return "IMAGE_BONUS100000";
	case IMAGE_BONUS5000LIGHT_ID:
		return "IMAGE_BONUS5000LIGHT";
	case IMAGE_BONUS10000LIGHT_ID:
		return "IMAGE_BONUS10000LIGHT";
	case IMAGE_BONUS25000LIGHT_ID:
		return "IMAGE_BONUS25000LIGHT";
	case IMAGE_BONUS50000LIGHT_ID:
		return "IMAGE_BONUS50000LIGHT";
	case IMAGE_BONUS100000LIGHT_ID:
		return "IMAGE_BONUS100000LIGHT";
	case IMAGE_BALL_ID:
		return "IMAGE_BALL";
	case IMAGE_YINYANG_ID:
		return "IMAGE_YINYANG";
	case IMAGE_GUIDERECT_ID:
		return "IMAGE_GUIDERECT";
	case IMAGE_GUIDERECT2_ID:
		return "IMAGE_GUIDERECT2";
	case IMAGE_ALPHABALL_ID:
		return "IMAGE_ALPHABALL";
	case IMAGE_GUIDEARROW_ID:
		return "IMAGE_GUIDEARROW";
	case IMAGE_GUIDEPOINT_ID:
		return "IMAGE_GUIDEPOINT";
	case IMAGE_GUIDEHIT_ID:
		return "IMAGE_GUIDEHIT";
	case IMAGE_BRICK_ID:
		return "IMAGE_BRICK";
	case IMAGE_BRICKCB_ID:
		return "IMAGE_BRICKCB";
	case IMAGE_BALLPEG_ID:
		return "IMAGE_BALLPEG";
	case IMAGE_BALLPEGCB_ID:
		return "IMAGE_BALLPEGCB";
	case IMAGE_BALLSHADOW_ID:
		return "IMAGE_BALLSHADOW";
	case IMAGE_PEGSHADOW_ID:
		return "IMAGE_PEGSHADOW";
	case IMAGE_BIGBALLSHADOW_ID:
		return "IMAGE_BIGBALLSHADOW";
	case IMAGE_BIGBALL_ID:
		return "IMAGE_BIGBALL";
	case IMAGE_DEFINNERPEG_ID:
		return "IMAGE_DEFINNERPEG";
	case IMAGE_DEFOUTERPEG_ID:
		return "IMAGE_DEFOUTERPEG";
	case IMAGE_CIRCLE_ID:
		return "IMAGE_CIRCLE";
	case IMAGE_FIREBALLFIRE_ID:
		return "IMAGE_FIREBALLFIRE";
	case IMAGE_FIREBALL_ID:
		return "IMAGE_FIREBALL";
	case IMAGE_COINHEADS_ID:
		return "IMAGE_COINHEADS";
	case IMAGE_COINTAILS_ID:
		return "IMAGE_COINTAILS";
	case IMAGE_COINHILIGHT_ID:
		return "IMAGE_COINHILIGHT";
	case IMAGE_BUBBLES_ID:
		return "IMAGE_BUBBLES";
	case IMAGE_BRICKGLOW_ID:
		return "IMAGE_BRICKGLOW";
	case IMAGE_PEGGLOW_ID:
		return "IMAGE_PEGGLOW";
	case IMAGE_PYRAMIDRAY_ID:
		return "IMAGE_PYRAMIDRAY";
	case IMAGE_FEVERRAY_ID:
		return "IMAGE_FEVERRAY";
	case IMAGE_FEVERGLOWSTAR_ID:
		return "IMAGE_FEVERGLOWSTAR";
	case IMAGE_FEVERSTAR_RED_ID:
		return "IMAGE_FEVERSTAR_RED";
	case IMAGE_FEVERSTAR_GREEN_ID:
		return "IMAGE_FEVERSTAR_GREEN";
	case IMAGE_FEVERSTAR_BLUE_ID:
		return "IMAGE_FEVERSTAR_BLUE";
	case IMAGE_FEVERSPARK_ID:
		return "IMAGE_FEVERSPARK";
	case IMAGE_FEVERTRAIL_ID:
		return "IMAGE_FEVERTRAIL";
	case IMAGE_FEVERRAINBOW_ID:
		return "IMAGE_FEVERRAINBOW";
	case IMAGE_FEVERSCORE_ID:
		return "IMAGE_FEVERSCORE";
	case IMAGE_FEVERSCORETOP_ID:
		return "IMAGE_FEVERSCORETOP";
	case IMAGE_STAR_STREAK_ID:
		return "IMAGE_STAR_STREAK";
	case IMAGE_TIPARROW_ID:
		return "IMAGE_TIPARROW";
	case IMAGE_BLUERIBBON_ID:
		return "IMAGE_BLUERIBBON";
	case IMAGE_TINYBLUERIBBON_ID:
		return "IMAGE_TINYBLUERIBBON";
	case IMAGE_MASTERBADGE_ID:
		return "IMAGE_MASTERBADGE";
	case IMAGE_PAUSED_ID:
		return "IMAGE_PAUSED";
	case IMAGE_CATCHERGLOW_ID:
		return "IMAGE_CATCHERGLOW";
	case IMAGE_PYRAMIDBALL_ID:
		return "IMAGE_PYRAMIDBALL";
	case IMAGE_JIMMY_ID:
		return "IMAGE_JIMMY";
	case IMAGE_JIMMYSPEECH_ID:
		return "IMAGE_JIMMYSPEECH";
	case IMAGE_FEVERCAM_ID:
		return "IMAGE_FEVERCAM";
	case IMAGE_XFEVER_ID:
		return "IMAGE_XFEVER";
	case IMAGE_XFEVERGLOW_ID:
		return "IMAGE_XFEVERGLOW";
	case IMAGE_PULSE_NORMAL_ID:
		return "IMAGE_PULSE_NORMAL";
	case IMAGE_PULSE_GOAL_ID:
		return "IMAGE_PULSE_GOAL";
	case IMAGE_PULSE_SCORE_ID:
		return "IMAGE_PULSE_SCORE";
	case IMAGE_PULSE_POWERUP_ID:
		return "IMAGE_PULSE_POWERUP";
	case IMAGE_PULSE2_SCORE_ID:
		return "IMAGE_PULSE2_SCORE";
	case IMAGE_PULSE2_POWERUP_ID:
		return "IMAGE_PULSE2_POWERUP";
	case IMAGE_SPACEBURST_ID:
		return "IMAGE_SPACEBURST";
	case IMAGE_SPACEBUBBLE_ID:
		return "IMAGE_SPACEBUBBLE";
	case IMAGE_SPACEHALO_ID:
		return "IMAGE_SPACEHALO";
	case IMAGE_SPACESTAR_ID:
		return "IMAGE_SPACESTAR";
	case IMAGE_SPOOKYPOOF1_ID:
		return "IMAGE_SPOOKYPOOF1";
	case IMAGE_SPOOKYPOOF2_ID:
		return "IMAGE_SPOOKYPOOF2";
	case IMAGE_SPOOKYGHOST_ID:
		return "IMAGE_SPOOKYGHOST";
	case IMAGE_SPOOKYTRAIL_ID:
		return "IMAGE_SPOOKYTRAIL";
	case IMAGE_SPOOKYEYES_ID:
		return "IMAGE_SPOOKYEYES";
	case IMAGE_EMBER_ID:
		return "IMAGE_EMBER";
	case IMAGE_SMOKE_ID:
		return "IMAGE_SMOKE";
	case IMAGE_FLECK_ID:
		return "IMAGE_FLECK";
	case IMAGE_FLAMETRAIL_ID:
		return "IMAGE_FLAMETRAIL";
	case IMAGE_NUKESTREAK_ID:
		return "IMAGE_NUKESTREAK";
	case IMAGE_DLG_BOTTOMBAR_ID:
		return "IMAGE_DLG_BOTTOMBAR";
	case IMAGE_DLG_RANDOM_ID:
		return "IMAGE_DLG_RANDOM";
	case IMAGE_DLG_BLUEFRAME_ID:
		return "IMAGE_DLG_BLUEFRAME";
	case IMAGE_DLG_SELECTORFRAME_ID:
		return "IMAGE_DLG_SELECTORFRAME";
	case IMAGE_DLG_BUTTON1_ID:
		return "IMAGE_DLG_BUTTON1";
	case IMAGE_DLG_BUTTON2_ID:
		return "IMAGE_DLG_BUTTON2";
	case IMAGE_DLG_BUTTON3_ID:
		return "IMAGE_DLG_BUTTON3";
	case IMAGE_DLG_BROWNBUTTON1_ID:
		return "IMAGE_DLG_BROWNBUTTON1";
	case IMAGE_DLG_BROWNBUTTON2_ID:
		return "IMAGE_DLG_BROWNBUTTON2";
	case IMAGE_DLG_GREENOK_ID:
		return "IMAGE_DLG_GREENOK";
	case IMAGE_DLG_POPUP_ID:
		return "IMAGE_DLG_POPUP";
	case IMAGE_DLG_TEXTBOX_ID:
		return "IMAGE_DLG_TEXTBOX";
	case IMAGE_DLG_HORZBAR_ID:
		return "IMAGE_DLG_HORZBAR";
	case IMAGE_DLG_LJOINT_ID:
		return "IMAGE_DLG_LJOINT";
	case IMAGE_DLG_EDITBUTTON_ID:
		return "IMAGE_DLG_EDITBUTTON";
	case IMAGE_DLG_DIALOGBOX_ID:
		return "IMAGE_DLG_DIALOGBOX";
	case IMAGE_DLG_SLIDER_ID:
		return "IMAGE_DLG_SLIDER";
	case IMAGE_DLG_SLIDERHILIGHT_ID:
		return "IMAGE_DLG_SLIDERHILIGHT";
	case IMAGE_DLG_SLIDERORB_ID:
		return "IMAGE_DLG_SLIDERORB";
	case IMAGE_DLG_FRAME1_ID:
		return "IMAGE_DLG_FRAME1";
	case IMAGE_DLG_FRAME2_ID:
		return "IMAGE_DLG_FRAME2";
	case IMAGE_DLG_FRAME3_ID:
		return "IMAGE_DLG_FRAME3";
	case IMAGE_DLG_SEGMENT_ID:
		return "IMAGE_DLG_SEGMENT";
	case IMAGE_DLG_CONNECTOR_ID:
		return "IMAGE_DLG_CONNECTOR";
	case IMAGE_DLG_REPLAYTOP_ID:
		return "IMAGE_DLG_REPLAYTOP";
	case IMAGE_DLG_REPLAYSEGMENT_ID:
		return "IMAGE_DLG_REPLAYSEGMENT";
	case IMAGE_DLG_STAGEBULLET_ID:
		return "IMAGE_DLG_STAGEBULLET";
	case IMAGE_DLG_MASTERSTAGE_ID:
		return "IMAGE_DLG_MASTERSTAGE";
	case IMAGE_DLG_MASTERSTAGEPROGBAR_ID:
		return "IMAGE_DLG_MASTERSTAGEPROGBAR";
	case IMAGE_DLG_PLAYWIDGET1_ID:
		return "IMAGE_DLG_PLAYWIDGET1";
	case IMAGE_DLG_PLAYWIDGET2_ID:
		return "IMAGE_DLG_PLAYWIDGET2";
	case IMAGE_DLG_PLAYBUTTON1_ID:
		return "IMAGE_DLG_PLAYBUTTON1";
	case IMAGE_DLG_PLAYBUTTON2_ID:
		return "IMAGE_DLG_PLAYBUTTON2";
	case IMAGE_DLG_STAGEBAR_ID:
		return "IMAGE_DLG_STAGEBAR";
	case IMAGE_DLG_STAGEPROGRESSBAR_ID:
		return "IMAGE_DLG_STAGEPROGRESSBAR";
	case IMAGE_DLG_TEXTRECT_ID:
		return "IMAGE_DLG_TEXTRECT";
	case IMAGE_DLG_QUESTIONMARK_ID:
		return "IMAGE_DLG_QUESTIONMARK";
	case IMAGE_DLG_TIP_ID:
		return "IMAGE_DLG_TIP";
	case IMAGE_DLG_INSTRUCTIONS_ID:
		return "IMAGE_DLG_INSTRUCTIONS";
	case IMAGE_DLG_INSTRUCTIONS2_ID:
		return "IMAGE_DLG_INSTRUCTIONS2";
	case IMAGE_DLG_INSTRUCTIONS3_ID:
		return "IMAGE_DLG_INSTRUCTIONS3";
	case IMAGE_DLG_INSTRUCTIONS4_ID:
		return "IMAGE_DLG_INSTRUCTIONS4";
	case IMAGE_DLG_BUTTONOVERLAY2_ID:
		return "IMAGE_DLG_BUTTONOVERLAY2";
	case IMAGE_DLG_STARBADGEICON_ID:
		return "IMAGE_DLG_STARBADGEICON";
	case IMAGE_DLG_TINYLOCKED_ID:
		return "IMAGE_DLG_TINYLOCKED";
	case IMAGE_DLG_PURPLEBUTTON_ID:
		return "IMAGE_DLG_PURPLEBUTTON";
	case IMAGE_DLG_MENU_ID:
		return "IMAGE_DLG_MENU";
	case IMAGE_DLG_INSTANTREPLAY_ID:
		return "IMAGE_DLG_INSTANTREPLAY";
	case IMAGE_CHR_CHARACTERS_ID:
		return "IMAGE_CHR_CHARACTERS";
	case IMAGE_CHR_CHARACTERSHADOWS_ID:
		return "IMAGE_CHR_CHARACTERSHADOWS";
	case IMAGE_CHR_CHARACTER1_ID:
		return "IMAGE_CHR_CHARACTER1";
	case IMAGE_CHR_CHARACTER2_ID:
		return "IMAGE_CHR_CHARACTER2";
	case IMAGE_CHR_CHARACTER3_ID:
		return "IMAGE_CHR_CHARACTER3";
	case IMAGE_CHR_CHARACTER4_ID:
		return "IMAGE_CHR_CHARACTER4";
	case IMAGE_CHR_CHARACTER5_ID:
		return "IMAGE_CHR_CHARACTER5";
	case IMAGE_CHR_CHARACTER6_ID:
		return "IMAGE_CHR_CHARACTER6";
	case IMAGE_CHR_CHARACTER7_ID:
		return "IMAGE_CHR_CHARACTER7";
	case IMAGE_CHR_CHARACTER8_ID:
		return "IMAGE_CHR_CHARACTER8";
	case IMAGE_CHR_CHARACTER9_ID:
		return "IMAGE_CHR_CHARACTER9";
	case IMAGE_CHR_CHARACTER10_ID:
		return "IMAGE_CHR_CHARACTER10";
	case IMAGE_CHR_CHARACTER11_ID:
		return "IMAGE_CHR_CHARACTER11";
	case IMAGE_CHR_YINYANGEYE_ID:
		return "IMAGE_CHR_YINYANGEYE";
	case IMAGE_SPIN_SPINNER_ID:
		return "IMAGE_SPIN_SPINNER";
	case IMAGE_SPIN_ARROW_ID:
		return "IMAGE_SPIN_ARROW";
	case IMAGE_SPIN_HATON_ID:
		return "IMAGE_SPIN_HATON";
	case IMAGE_SPIN_EXTRAON_ID:
		return "IMAGE_SPIN_EXTRAON";
	case IMAGE_SPIN_TRIPLEON_ID:
		return "IMAGE_SPIN_TRIPLEON";
	case IMAGE_SPIN_RANDOMON_ID:
		return "IMAGE_SPIN_RANDOMON";
	case IMAGE_SPIN_RANDOMTEXT_ID:
		return "IMAGE_SPIN_RANDOMTEXT";
	case IMAGE_SPIN_RANDOMTEXTON_ID:
		return "IMAGE_SPIN_RANDOMTEXTON";
	case IMAGE_SPIN_RIMLIGHT_ID:
		return "IMAGE_SPIN_RIMLIGHT";
	case IMAGE_SPIN_RIMLIGHT2_ID:
		return "IMAGE_SPIN_RIMLIGHT2";
	case IMAGE_STORY_WIN_ID:
		return "IMAGE_STORY_WIN";
	case IMAGE_STORY_CLAWS_ID:
		return "IMAGE_STORY_CLAWS";
	case IMAGE_STORY_ROCKET_ID:
		return "IMAGE_STORY_ROCKET";
	case IMAGE_STORY_BIGSPARKLE_ID:
		return "IMAGE_STORY_BIGSPARKLE";
	case IMAGE_ADV_ADVENTURE_ID:
		return "IMAGE_ADV_ADVENTURE";
	case IMAGE_ADV_RESTART_COVER_ID:
		return "IMAGE_ADV_RESTART_COVER";
	case IMAGE_UPSELL_LEVEL1_ID:
		return "IMAGE_UPSELL_LEVEL1";
	case IMAGE_UPSELL_LEVEL2_ID:
		return "IMAGE_UPSELL_LEVEL2";
	case IMAGE_UPSELL_LEVEL3_ID:
		return "IMAGE_UPSELL_LEVEL3";
	case IMAGE_UPSELL_LEVEL4_ID:
		return "IMAGE_UPSELL_LEVEL4";
	case IMAGE_UPSELL_LEVEL5_ID:
		return "IMAGE_UPSELL_LEVEL5";
	case IMAGE_UPSELL_LEVEL6_ID:
		return "IMAGE_UPSELL_LEVEL6";
	case IMAGE_UPSELL_LEVEL7_ID:
		return "IMAGE_UPSELL_LEVEL7";
	case IMAGE_UPSELL_LEVEL8_ID:
		return "IMAGE_UPSELL_LEVEL8";
	case IMAGE_UPSELL_LEVEL9_ID:
		return "IMAGE_UPSELL_LEVEL9";
	case IMAGE_UPSELL_LEVEL10_ID:
		return "IMAGE_UPSELL_LEVEL10";
	case IMAGE_UPSELL_BUY_NOW_ID:
		return "IMAGE_UPSELL_BUY_NOW";
	case IMAGE_UPSELL_BALL_ID:
		return "IMAGE_UPSELL_BALL";
	case IMAGE_UPSELL_TEXT_ID:
		return "IMAGE_UPSELL_TEXT";
	case IMAGE_UPSELL_LOGO_ID:
		return "IMAGE_UPSELL_LOGO";
	case IMAGE_UPSELL_PEG_ID:
		return "IMAGE_UPSELL_PEG";
	case IMAGE_UPSELL_SWOOSH_ID:
		return "IMAGE_UPSELL_SWOOSH";
	case IMAGE_UPSELL_BLURB1_ID:
		return "IMAGE_UPSELL_BLURB1";
	case IMAGE_UPSELL_BLURB2_ID:
		return "IMAGE_UPSELL_BLURB2";
	case IMAGE_UPSELL_BLURB3_ID:
		return "IMAGE_UPSELL_BLURB3";
	case IMAGE_UPSELL_BLURB4_ID:
		return "IMAGE_UPSELL_BLURB4";
	case IMAGE_UPSELL_BLURB5_ID:
		return "IMAGE_UPSELL_BLURB5";
	case IMAGE_UPSELL_BLURB6_ID:
		return "IMAGE_UPSELL_BLURB6";
	case IMAGE_UPSELL_BLURB7_ID:
		return "IMAGE_UPSELL_BLURB7";
	case IMAGE_UPSELL_BLURB8_ID:
		return "IMAGE_UPSELL_BLURB8";
	case IMAGE_UPSELL_BLURB9_ID:
		return "IMAGE_UPSELL_BLURB9";
	case IMAGE_UPSELL_BLURB10_ID:
		return "IMAGE_UPSELL_BLURB10";
	case IMAGE_UPSELL_ZEN_ID:
		return "IMAGE_UPSELL_ZEN";
	case IMAGE_UPSELL_JUNK1_ID:
		return "IMAGE_UPSELL_JUNK1";
	case IMAGE_UPSELL_JUNK2_ID:
		return "IMAGE_UPSELL_JUNK2";
	case IMAGE_UPSELL_JUNK3_ID:
		return "IMAGE_UPSELL_JUNK3";
	case IMAGE_UPSELL_JUNK4_ID:
		return "IMAGE_UPSELL_JUNK4";
	default:
		return "";
	}
}
