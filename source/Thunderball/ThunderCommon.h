...
float InterpValF(int currentTime, int phase1Duration, int phase2Duration, float startVal, float midVal, float endVal);
...
ThunderButton* MakeButton(int theId, ButtonListener* theListener, const std::string& theString, Image* theImage);
ThunderButton* MakePurpleButton(int theId, ButtonListener* theListener, const std::string& theString);
...
void DrawCircle(Graphics *g, float param_2, float param_3, float param_4, Image *param_5, Rect *param_6, int param_7);
void DrawCharacterPlusFrame(Graphics *g, int param_2, int param_3, int param_4);
// 04896b0 DoDrawStat
} // namespace Sexy
