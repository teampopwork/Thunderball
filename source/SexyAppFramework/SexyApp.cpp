...
// FUNCTION: POPCAPGAME1 0x00524db0
SexyApp::SexyApp()
{
	gSexyApp = this;
	...
	mInternetManager = NULL;//new InternetManager();
	mBetaSupport = NULL;
	mBetaValidate = false;	
...
// FUNCTION: POPCAPGAME1 0x00524ae0
SexyApp::~SexyApp()
{
	delete mBetaSupport;
...
// FUNCTION: POPCAPGAME1 0x00524ff0
...
// FUNCTION: POPCAPGAME1 0x00525960
...
// FUNCTION: POPCAPGAME1 0x00526580
...
// FUNCTION: POPCAPGAME1 0x00527c70
...
// FUNCTION: POPCAPGAME1 0x005281f0
...
// FUNCTION: POPCAPGAME1 0x00524960
...
// FUNCTION: POPCAPGAME1 0x005249d0
...
// FUNCTION: POPCAPGAME1 0x00524a00
...
// FUNCTION: POPCAPGAME1 0x005266b0
...
// FUNCTION: POPCAPGAME1 0x005269f0
...
// FUNCTION: POPCAPGAME1 0x00526d80
...
// FUNCTION: POPCAPGAME1 0x00527950
...
// FUNCTION: POPCAPGAME1 0x00527180
void SexyApp::InitPropertiesHook()
{
	...
	mBetaSupport = NULL;//new BetaSupport(this);
...
// FUNCTION: POPCAPGAME1 0x00527580
void SexyApp::Init()
{
	SEHCatcher::mCrashMessage = 
		L"An unexpected error has occured!  Pressing 'Send Report' "
		L"will send us helpful debugging information that may help "
		L"us resolve this issue in the future.\r\n\r\n"
		L"You can also contact us directly at feedback@popcap.com.";

	SEHCatcher::mSubmitMessage = 
		L"Please help us out by providing as much information as "
		L"you can about this crash. Is this the first time it happened? "
		L"Have you used other PopCap Deluxe games successfully before? "
		L"Have you upgraded your drivers or any software recently that "
		L"may be interfering with this program?";

	SEHCatcher::mSubmitErrorMessage = 
		L"Failed to connect to PopCap servers.  Please check your Internet connection.\n"
		L"If you are on a dial-up connection, you may have to manually connect to your ISP.";
...
// FUNCTION: POPCAPGAME1 0x00524ac0
